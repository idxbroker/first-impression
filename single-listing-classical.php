...
if (function_exists('equity')) {
	...
	remove_all_actions( 'equity_header' );
	...
	//* Remove post title and markup -added in later
	...
	remove_action( 'equity_before_content_sidebar_wrap', 'equity_child_entry_full_width_header' );

	//* Remove content and add custom content
	...
	//* Remove after entry widget area
	remove_action( 'equity_after_entry', 'equity_after_entry_widget_area' );

	//* Remove site footer widgets
	remove_action( 'equity_before_footer', 'equity_footer_widget_areas' );
	remove_action( 'equity_footer', 'equity_footer_widget_areas', 6 );
	...
	remove_all_actions( 'equity_footer' );

	equity();

} elseif (function_exists('genesis_init')) {

	// Add responsive viewport if Genesis child theme doesn't
	...
	//* Remove breadcrumbs, post meta and info, and author box
	...
	remove_action( 'genesis_after_post', 'genesis_get_comments_template' ); // XHTML
	...
	//* AE child themes
	remove_action('genesis_before_content', 'picture_perfect_site_title_description_markup', 1);
